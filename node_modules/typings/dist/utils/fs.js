...
function readHttp(url) {
    var proxy = rc_1.default.proxy, rejectUnauthorized = rc_1.default.rejectUnauthorized, ca = rc_1.default.ca, key = rc_1.default.key, cert = rc_1.default.cert, userAgent = rc_1.default.userAgent;
    var agent = proxy ? new ProxyAgent(proxy) : null;
    return popsicle.get({
        url: url,
        headers: {
